...
//                fail("NotDivisibleException should not have occurred during test of conjugate().\n" + nde.getMessage() + "\nThere may be a mistake in the setup of the test.");
    ...
    public void testAbs() {
        ...
        /* And lastly, extra tests for a few Gaussian integers and Eisenstein 
           integers */
        QuadraticInteger gauInt = new ImaginaryQuadraticInteger(0, 0, ringGaussian);
        QuadraticInteger eisenInt = new ImaginaryQuadraticInteger(0, 0, ringEisenstein);
//        for (int n = 1; n < 25; n++) {
...
//            result = eisenInt.abs();
//            assertEquals(n, result, ImaginaryQuadraticRingTest.TEST_DELTA);
//            eisenInt = eisenInt.times(NumberTheoreticFunctionsCalculator.COMPLEX_CUBIC_ROOT_OF_UNITY); // n * omega
//            result = eisenInt.abs();
//            assertEquals(n, result, ImaginaryQuadraticRingTest.TEST_DELTA);
//            eisenInt = eisenInt.times(NumberTheoreticFunctionsCalculator.COMPLEX_CUBIC_ROOT_OF_UNITY); // n * omega^2
//            result = eisenInt.abs();
//            assertEquals(n, result, ImaginaryQuadraticRingTest.TEST_DELTA);
//            eisenInt = eisenInt.times(NumberTheoreticFunctionsCalculator.COMPLEX_CUBIC_ROOT_OF_UNITY);
...
//    }
    ...
    public void testParseQuadraticIntegerOptions() {
        ...
        QuadraticInteger expResult = new ImaginaryQuadraticInteger(0, 1, ringGaussian);
        ...
        try {
            result = QuadraticInteger.parseQuadraticInteger(ringZi2, numberString);
            assertEquals(zeroIQI, result);
        } catch (NumberFormatException nfe) {
            System.out.println("Testing the option to have an empty String stand for 0 triggered NumberFormatException \"" + nfe.getMessage() + "\"");
...
//                fail(failMessage);
        ...
        testDivisor = new ImaginaryQuadraticInteger(0, 1, ringZi2);
