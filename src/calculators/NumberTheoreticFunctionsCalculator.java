...
//        }
     ...
     * {@code n} if {@code n} happens to itself be squarefree. For the three 
     * examples given above, the result would be 4751, which is a prime number. 
     * If {@code n} happens to be {@code Integer.MIN_VALUE + 1} or {@code 
     * Integer.MIN_VALUE}, the result will be incorrectly given as {@code 
     * Integer.MAX_VALUE}, which is wrong; the correct result is just outside 
     * the range of {@code int} (namely &minus;2147483649).
     */
    ...
    /**
     * Gives the next highest squarefree number after a given number. No 
     * overflow checking is provided.
     ...
     * @return The next highest squarefree number. It will be different from 
     * {@code n} if {@code n} happens to itself be squarefree. For the three 
     * examples given above, the result would be 4754, which factorizes as 2 
     * &times; 2377. If {@code n} happens to be {@code Integer.MAX_VALUE}, the 
     * result will be incorrectly given as {@code Integer.MIN_VALUE + 1}, which 
     * is wrong; the correct result is just outside the range of {@code int} 
     * (namely 2147483649).
     */
